import { CustomColorProperty } from "./CustomColorProperty"
...
export class PolylineArrowsMaterialProperty implements Cesium.MaterialProperty {
  ...
  constructor(viewer: Cesium.Viewer, cartesian3s: Array<Cesium.Cartesian3>, color: Cesium.Color) {
    this.color = new CustomColorProperty(color) 
